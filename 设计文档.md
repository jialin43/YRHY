...
|请求路径|/crud/rl|
|所在类|CRUDController|
|参数|name:String:染料名称</br>casNo:String:CAS编码</br>lhsxb_srjd_key_value:String:水溶解度</br>lhsxb_bhzqy_key_value:String:饱和蒸汽压|
|返回值|id/-1:int:添加成功/失败|
...
|请求路径|/crud/zj|
|所在类|CRUDController|
|参数|name:String:助剂名称</br>casNo:String:CAS编码</br>lhsxb_srjd_key_value:String:水溶解度</br>lhsxb_bhzqy_key_value:String:饱和蒸汽压|
|返回值|id/-1:int:添加成功/失败|
#### 修改数据
...
|请求路径|/crud/rl/id|
|所在类|CRUDController|
|参数|id:String:ID</br>name:String:染料名称</br>casNo:String:CAS编码</br>lhsxb_srjd_key_value:String:水溶解度</br>lhsxb_bhzqy_key_value:String:饱和蒸汽压|
|返回值|id/-1:int:修改成功/失败|
...
|请求路径|/crud/zj/id|
|所在类|CRUDController|
|参数|id:String:ID</br>name:String:助剂名称</br>casNo:String:CAS编码</br>lhsxb_srjd_key_value:String:水溶解度</br>lhsxb_bhzqy_key_value:String:饱和蒸汽压|
|返回值|id/-1:int:修改成功/失败|
#### 删除数据
