  ...
  <div class="headbar" :style="{'background':themeColor}"
    ...
    <span class="hamburg">
      <el-menu class="el-menu-demo" :background-color="themeColor" text-color="#fff" :active-text-color="themeColor"
               mode="horizontal">
        <el-menu-item index="1" @click="onCollapse"></el-menu-item>
      </el-menu>
    </span>
    <!-- 导航菜单 -->
    <span class="navbar">
...
<!--        <el-menu-item index="5" @click="$router.push('/mapdatamax')">地图展示</el-menu-item>-->
<!--        <el-menu-item index="3" @click="$router.push('/surveyList')">问卷填写</el-menu-item>-->
<!--        <el-menu-item index="3" @click="$router.push('/singledatamax1')">单次数据展示</el-menu-item>-->
<!--        <el-menu-item index="5" @click="$router.push('/multidatamax1')">多次数据展示</el-menu-item>-->
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.sysName = "西北乡村特征调查数据库与可视化平台"
