<template>
  <div class="personal-panel">
    <div class="personal-desc" :style="{'background':this.$store.state.app.themeColor}">
        ...
        <div class="name-role">
          <span class="sender">{{ user.name }} - {{ user.nickname }}</span>
        </div>
...
<!--        </span>-->
        <span class="main-operation-item">
          <el-button size="small" icon="fa fa-key" @click="showPasswordDialog"> 修改密码</el-button>
        </span>
    </div>
...
<!--    <backup ref="backupDialog" @afterRestore="afterRestore"></backup>-->
    <Password ref="passwordDialog"></Password>
  </div>
</template>
